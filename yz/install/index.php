	...
	if (!$error_msg) {
        ...
        if ($conn) {
            if (@mysqli_select_db($conn, $_POST['db_name'])) {
                ...
                $userdata = file_get_contents($web_mulu.'/houtai/userdata.php');
                ...
                file_put_contents($web_mulu.'/houtai/userdata.php', $userdata);
				//-------生成唯一随机串防CSRF攻击
...
<html lang="en">
    <head>
        ...
        <meta content="A fully featured houtai theme which can be used to build CRM, CMS, etc." name="description" />
							...
							<div class="card-body">
								<div class="text-center">
									...
									<div class="mb-3 mt-2">
										...
										<a href="../houtai" class="btn btn-success">前往后台</a>
									</div>
								</div>
							</div> <!-- end card-body-->
						</div> <!-- end card-->
